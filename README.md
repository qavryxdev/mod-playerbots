...
Then build the server following the platform-specific instructions in our **[Installation Guide](https://github.com/qavryxdev/mod-playerbots/wiki/Installation-Guide)**.
